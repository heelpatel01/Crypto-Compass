...
exports.NotImplementedException = exports.UnacceptableException = exports.MethodNotAllowedException = exports.TooManyRequestException = exports.PayloadTooLargeException = exports.ForbiddenException = exports.DuplicateEntryException = exports.BadGatewayException = exports.UnAuthorizedException = exports.NotFoundException = exports.ServerErrorException = exports.createHandlers = exports.HttpException = void 0;
class HttpException extends Error {
     ...
     * @return {void}
     */
    ThrowNewException({ name, message, stack }) {
 ...
 */
function UnhandledRoutes(req, res, next) {
...
function ExceptionHandler(err, req, res, next) {
    ...
    const errStatus = HttpException.TypeOfError(err.name) || 500;
    ...
    res
        ...
        success: false,
        status: errStatus,
        type: (_a = err.name) === null || _a === void 0 ? void 0 : _a.replace(/_/g, " "),
        message: err.message,
        stack: err.stack
    });
    next(errMsg);
